...
<body>
	...
	{
	%>    
	<form action="Buy" method="post" enctype="multipart/form-data" class="requires-validation" novalidate style="text-align: center;">
				...
				<thead>
					...
					<tr>
						 ...
						 <% 
					        ...
					        List<CartModel> list = Dao.getAllCart();
							...
							<div class="col-md-12">
                               <input class="form-control" type="hidden" name="id" value="<%=m.getId() %>" required>
                            </div>
                            <div class="col-md-12">
						...
						<tr><td><%=m.getP_name() %></td><td><%=m.getP_price() %></td><td><%=m.getP_des() %></td><td><img src="data:image/jpeg;base64,<%=m.getP_image()%>" width="150px" height="200px" /></td><td><button id="submit" type="submit" class="btn btn-primary">Buy</button></td>
						<td><form action="removecart.jsp">
						 <div class="col-md-12">
